...
import (
	...
	event "github.com/abhilashdk2016/go-microservice/broker/event"
	"github.com/abhilashdk2016/go-microservice/broker/logs"
...
func (app *Config) LogViaGrpc(w http.ResponseWriter, r *http.Request) {
	...
	_, err = c.WriteLog(ctx, &logs.LogRequest{
		LogEntry: &logs.Log{
			Name: requestPaylod.Log.Name,
			Data: requestPaylod.Log.Data,
		},
	})
